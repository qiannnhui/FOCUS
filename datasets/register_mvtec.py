...
_PREDEFINED_SPLITS_MVTEC = {
    "mvtec_train": (
        ...
        "MVTEC/mvtec_train_INSTANCE.json",  # `train` 仍然需要 Instance JSON（即便 annotations 為空）
    ),
    "mvtec_val": (
        "MVTEC",  # `test` 圖片
        "MVTEC",  # `test` ground truth
        "MVTEC/mvtec_val_SEMANTIC.json",  # `test` semantic segmentation
        "MVTEC/mvtec_val_INSTANCE.json",  # `test` instance segmentation
    ),
}
