...
_PREDEFINED_SPLITS_MVTEC = {
    "mvtec_good": (
        "mvtec_good/images", 
        "mvtec_good/ground_truth_mask", 
        "mvtec_good/MVTEC_SEMANTIC.json",
        "mvtec_good/annotations_detectron2/ground_truth_mask", 
        "mvtec_good/MVTEC_INSTANCE.json"
    ),
...
def register_all_ecssd_panoptic(root):
    ...
    ) in _PREDEFINED_SPLITS_MVTEC.items():
