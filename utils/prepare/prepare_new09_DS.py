...
def create_instance_dataset(dataset_dir, output_dir):
    ...
    # Save to file
    output_file_path = os.path.join(output_dir, f"new09_DS_INSTANCE.json")
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    with open(output_file_path, 'w') as f:
        json.dump(coco_format, f)
    print(f"new09_DS in COCO format is saved to {output_file_path}")
def create_semantic_dataset(dataset_dir, output_dir):
    ...
    # Save to file
    output_file_path = os.path.join(output_dir, f"new09_DS_SEMANTIC.json")
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    with open(output_file_path, 'w') as f:
        json.dump(coco_format, f)
...
if __name__ == "__main__":
    dataset_dir = "datasets/new09_DS"  # Update this to the path of your dataset
    output_dir = "datasets/new09_DS"  # Update this to your desired output directory
