...
from focus.utils.events import WandbWriter, setup_wandb
from detectron2.evaluation import (
    DatasetEvaluators,
    verify_results,
)
from focus.evaluation.evaluation import UNIFIEDEvaluator
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "unified":
            evaluator_list.append(UNIFIEDEvaluator(dataset_name, output_dir=output_folder))
